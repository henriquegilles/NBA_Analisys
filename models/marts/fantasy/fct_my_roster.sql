-- fct_my_roster
-- Grão: 1 linha por jogador do meu elenco (Bandeja de 3).
--
-- Liga o roster (seed my_roster, D-02/Fase 2) à valoração NBA por categoria
-- (fct_player_fantasy_value_season) e aos contratos fantasy (seed
-- fantasy_contracts, D-18). Jogador sem stats NBA 2025-26 (calouro/prospecto)
-- fica com `has_nba_value` = false e z-scores NULL → olhar no scouting (Domínio B).
-- Base do perfil de forças/fraquezas do time (D-17) e da situação de cap.
...
select
    ...
    -- Valoração NBA (temporada passada) — NULL se calouro/sem stats
    v.games_played,
    v.minutes_per_game,
