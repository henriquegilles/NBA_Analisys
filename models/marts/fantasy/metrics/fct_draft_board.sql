...
-- Board de draft ajustado por OPORTUNIDADE (talento × situação do time NBA final).
-- Corrige o erro de "draft-night vs time final" com o seed nba_landing_spots.
with dc as (
...
select
    ...
    -- score de talento (cats ponderadas) × oportunidade
    round((
    ...
    p.confidence                     as model_confidence  -- nunca esconder a incerteza
from dc
