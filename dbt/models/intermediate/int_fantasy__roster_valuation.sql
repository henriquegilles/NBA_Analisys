...
-- Mine/league: every rostered player × NBA valuation (joined on normalized name).
-- Derives punt-TOV VA = z_total - z_tov (the central metric in the Bandeja de 3 context).
with roster as (
...
select
    ...
    (v.player_key is null)              as unmatched  -- rookie / no 25-26 stats
from roster r
